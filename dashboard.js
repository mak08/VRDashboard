...
var controller = function () {
    ...
    function commonTableLines(r) {
        ...
        var sailNameBG = r.curr.badSail ? "#F08080" : "#90EE90";

        var twaFG = (r.curr.twa < 0) ? "#FF0000" : "#008000";
        var twaBold = r.curr.twaAuto ? "font-weight: bold;" : "";
        var hdgFG = r.curr.twaAuto ? "#000000" : "#0000FF";
    ...
    function makeRaceStatusLine(pair) {
        ...
        if (r.curr == undefined) {
            ...
            var agroundBG = r.curr.aground ? "#F08080" : "#90EE90";
            ...
            if (r.curr.fullOptions !== undefined) {
                ...
                if (r.curr.regPack) {
                    if (r.curr.regPack.tsNext > r.curr.lastCalcDate) {
                        ...
                        regPack = "Ready";
                        regColor = ' style="background-color: #90EE90;"';
                    }
                }
                if (r.curr.soloCard) {
                    regPack += '<br>Solo: ';
    ...
    function makeTableLine(r) {
        ...
        function getBG(timestamp) {
            return isCurrent(timestamp) ? ('style="background-color: #F08080;"') : "";
        }
        ...
        if (isPenalty()) {
            speedCStyle = 'style="background-color: #F08080;"';
        } else if (isDifferingSpeed(r.curr.speedC)) {
            speedCStyle = 'style="background-color: #FFFF00;"';
            ...
            speedTStyle = 'style="background-color: #F08080;"';
